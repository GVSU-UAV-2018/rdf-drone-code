...
freq_offset = 3000
bandwidth = 1000
gains = [9, 1, 1] #[1, 1, 15] #LNA: 1, MIXER: 1, IF: 20 as per prev group
SNR = 5.0
...
class RDF_Detection_No_GUI(gr.top_block):
    ...
    def __init__(self):
        ...
        #self.fcdproplus_fcdproplus_0.set_if_gain(20) #20
        #self.fcdproplus_fcdproplus_0.set_freq_corr(0)
        #self.fcdproplus_fcdproplus_0.set_freq(self.collar_freq - self.freq_offset)
